            ...
            return (
              ...
              >
                ...
                <div className="mt-3 grid gap-3 md:grid-cols-2">
                  ...
                  <ReleaseManagementDeliveryFormatSelector
                    draft={draft}
                    onToggleFormat={(format, checked) => {
                      const nextFormats: DeliveryFormat[] = checked
                        ? Array.from(new Set<DeliveryFormat>([...draft.deliveryFormats, format]))
                        : draft.deliveryFormats.filter((value) => value !== format);
